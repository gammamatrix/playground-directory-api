...
Route::group([
    ...
    Route::get('/{location:slug}', [
        'as' => 'playground.directory.api.locations.slug',
        'uses' => 'LocationController@show',
    ])->where('slug', '[a-zA-Z0-9\-]+');
});

Route::group([
    'prefix' => 'api/directory/locations',
    'middleware' => config('playground-directory-api.middleware.default'),
    'namespace' => '\Playground\Directory\Api\Http\Controllers',
], function () {
    Route::get('/', [
    ...
    // Route::get('/go/{id}', [
    //     'as' => 'playground.directory.api.locations.go',
    //     'uses' => 'LocationController@go',
    // ]);

    Route::get('/{location}', [
        'as' => 'playground.directory.api.locations.show',
        'uses' => 'LocationController@show',
    ])->whereUuid('location')->can('detail', 'location');

    Route::get('/{location}/revisions', [
        'as' => 'playground.directory.api.locations.revisions',
    ...
    Route::get('/revision/{location_revision}', [
        'as' => 'playground.directory.api.locations.revision',
    ...
    Route::put('/revision/{location_revision}', [
        'as' => 'playground.directory.api.locations.revision.restore',
    ...
    //
    // Route::put('/{location}', [
    //     'as' => 'playground.directory.api.locations.put.id',
    //     'uses' => 'LocationController@store',
    // ])->whereUuid('location')->can('update', 'location');

    Route::patch('/{location}', [
        'as' => 'playground.directory.api.locations.patch',
