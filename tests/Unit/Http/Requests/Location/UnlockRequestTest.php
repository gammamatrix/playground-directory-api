...
/**
 * \Tests\Unit\Playground\Directory\Api\Http\Requests\Location\UnlockRequestTest
 */
class UnlockRequestTest extends RequestTestCase
{
    protected string $requestClass = \Playground\Directory\Api\Http\Requests\Location\UnlockRequest::class;
}
