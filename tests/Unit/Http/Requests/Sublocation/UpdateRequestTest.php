...
use Playground\Directory\Api\Http\Requests\Sublocation\UpdateRequest;
use Tests\Unit\Playground\Directory\Api\Http\Requests\RequestTestCase;

/**
 * \Tests\Unit\Playground\Directory\Api\Http\Requests\Sublocation\UpdateRequestTest
 */
class UpdateRequestTest extends RequestTestCase
{
    ...
    {
        config(['playground-directory-api.revisions.optional' => false]);
    ...
    {
        config(['playground-directory-api.revisions.optional' => true]);
        $instance = new UpdateRequest;
        $rules = $instance->rules();
        $this->assertNotEmpty($rules);
        $this->assertIsArray($rules);
