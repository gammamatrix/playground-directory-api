...
namespace Playground\Directory\Api;
...
class ServiceProvider extends AuthServiceProvider
{
    ...
    public string $package = 'playground-directory-api';
    ...
    public function boot(): void
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            // Publish routes
            $this->publishes([
                dirname(__DIR__).'/routes' => base_path('routes/playground-directory-api'),
            ], 'playground-routes');
        }
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/config/playground-directory-api.php',
            $this->package
        );
    }
    ...
    public function about(): void
    {
        ...
        AboutCommand::add('Playground: Directory API', fn () => [
